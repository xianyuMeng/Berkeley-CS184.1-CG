            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                // Also look at demo.txt to get a sense of why things are done this way.
                    ...
                    if (validinput) {
						...
						glm::mat4 translate = Transform::translate(values[0], values[1], values[2]);
                    ...
                    if (validinput) {
                        ...
                        // Also keep in mind what order your matrix is!
						glm::vec3 axis = vec3(values[0], values[1], values[2]);
						axis = glm::normalize(axis);
						const float degree = values[3];
						glm::mat3 rotate = Transform::rotate(degree, axis);
						glm::mat4 Rotate(1.0);
